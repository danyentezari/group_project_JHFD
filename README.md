...
- [ ] Add an email address to the `ADMINS` settings variable in `group_project_JHFD/group_project_JHFD/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `group_project_JHFD/group_project_JHFD/settings/production.py`
...
- Create a copy of ``group_project_JHFD/settings/local.py.example``:  
  `cp group_project_JHFD/settings/local.py.example group_project_JHFD/settings/local.py` (remembering you should replace `group_project_JHFD` with your project's name!).
